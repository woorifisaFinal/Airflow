...
def nikkei_lstm(cfg):
    ...
    if cfg.base.mode=='infer':
        ...
        # df.to_csv(opj(cfg.base.output_dir, "df.csv"))
        # dates.to_frame().to_csv(opj(cfg.base.output_dir, "dates.csv"))
        ...
        # test.to_csv(opj(cfg.base.output_dir, "test_df.csv"))
        # test_dates.to_frame().to_csv(opj(cfg.base.output_dir, "test_dates.csv"))
        ...
        for i in range(seq_len, len(val_data_scaled) - pred_days + 1):
            ...
            # base_dates추가
            val_dates_for_infer.append(val_dates[i]) # .values[0]
        ...
        for i in range(seq_len, len(test_data_scaled) - pred_days + 1):
            ...
            # base_dates추가
            test_dates_for_infer.append(test_dates[i]) # .values[0]
