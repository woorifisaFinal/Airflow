...
python -m stage1.tools.infer -C ${config_dir}/tw/us3y_lstm_infer.yml -D ${today}
python -m stage1.tools.infer -C ${config_dir}/sm/ftse_lstm_infer.yml -D ${today}
python -m stage1.tools.infer -C ${config_dir}/sm/nasdaq_lstm_infer.yml -D ${today}
python -m stage1.tools.infer -C ${config_dir}/sm/nikkei_lstm_infer.yml -D ${today}
python -m stage1.tools.infer -C ${config_dir}/jh/brazil_lstm_infer.yml -D ${today}
python -m stage1.tools.infer -C ${config_dir}/jh/india_lstm_infer.yml -D ${today}
